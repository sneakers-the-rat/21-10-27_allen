...
Quotes from Christoph Koch re: scale of organization

How do we make labor cumulative?

Plugin figure, monospoked vs densely connected
...
Add IBL documentation on right
